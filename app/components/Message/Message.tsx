...
const Message: FC<{ message: MessageT }> = ({message}) => {
    ...
    return (
        <View key={message.id} style={{
            ...styles.message,
            backgroundColor: message.author == MessageAuthor.AI ? 'transparent' : backgroundColor,
            alignSelf: message.author == MessageAuthor.Human ? "flex-end" : "flex-start"
        }}>
            {message.author === MessageAuthor.Human && <Text style={{color: textColor}}>{message.content}</Text>}
